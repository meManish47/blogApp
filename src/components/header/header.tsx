...
export default function Header() {
  ...
  return (
    <header className="w-screen border-b shadow-sm ">
      <div className="max-w-full mx-auto px-2 sm:px-20 h-16 flex items-center justify-between">
        <Link
          href="/"
          className="text-base w-40 sm:text-2xl sm:w-max  font-bold hover:opacity-80  transition-opacity"
        >
          Blog App
        </Link>
        <ModeToggle />
